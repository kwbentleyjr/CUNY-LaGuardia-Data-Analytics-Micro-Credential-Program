...
SELECT student_id, unit4 FROM student_marks WHERE unit4 BETWEEN 89 AND 100 ORDER BY student_id;
...
SELECT 
	ROUND(AVG(unit2), 2) AS "UNIT 2 AVERAGE", 
	ROUND(AVG(unit3), 2) AS "UNIT 3 AVERAGE", 
	ROUND(AVG(unit4), 2) AS "UNIT 4 AVERAGE", 
	ROUND(AVG(unit5), 2) AS "UNIT 5 AVERAGE" 
FROM student_marks;
